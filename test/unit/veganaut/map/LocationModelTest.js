...
describe('LocationModel.', function() {
    ...
    it('knows when you can make a visitBonus mission.', function() {
        var loc = new Location (undefined, undefined, undefined, undefined, undefined, undefined, undefined,
            new Date()
        );
        ...
        loc = new Location (undefined, undefined, undefined, undefined, undefined, undefined, undefined,
